...
You can specify a database used by Vikunja. By default it is configured to use SQLite, and the SQLite database is stored in the directory specified with `vikunja_data_path`.
